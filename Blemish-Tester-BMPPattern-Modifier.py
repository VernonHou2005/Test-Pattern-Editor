...
def createBMP(event):
    ...
    if fileFullPath[-3:] != 'csv':
        ...
        img = Image.open('/Users/vernonhou/WorkSpace/Code-Repository/Python/Test-Pattern-Editor/VID-Checker-1824x1920.bmp')
        pixels = img.load()
        ...
        if chkLeftValue.get():
            ...
            imgRight= img
            imgLeftMargin = Image.new('RGB',(24,int(imgHeightSettingEntry.get())),(0,0,0))
            ...
            imgHMD.paste(imgLeftMargin,(0,0))
            imgHMD.paste(imgRight,(imgLeft.size[0]+24,0))
            img= imgHMD
            saveName= fileFullPath.rstrip(
